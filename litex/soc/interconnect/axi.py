...
class Wishbone2AXI(Module):
    ...
    LiteX is not supporting bursts on the wishbone bus, so when used in LiteX,
    This interface is actually using AXI Lite and then adapting it to AXI.
    See #466 for more details.
    '''
